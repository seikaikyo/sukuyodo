    ...
    SANKI_DAY_TYPES = {
        ...
        "day": {
            ...
            5: {"name": "危の日", "reading": "きのひ",
                "description": "原典記載「宜結交、定婚姻，歡宴聚會並吉」，但另記「危壊日，並不宜遠行出、入移徙、買賣、婚姻、裁衣、剃頭、沐浴並凶」（注：婚姻在兩處記載吉凶不同）。社交聚會吉，遠行買賣則宜避開。",
                "description_ja": "原典に「結交を宜し、婚姻を定め、歓宴聚会並びに吉」とある一方、「危壊日は並びに遠行出・入移徙・売買・婚姻・裁衣・剃頭・沐浴に宜しからず並びに凶」とも（注：婚姻の吉凶が箇所により異なる）。社交は吉、遠行・売買は避けるのが良い。"},
