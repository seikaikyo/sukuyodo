...
class SukuyodoService:
    ...
    SPECIAL_DAY_INFO = {
        "kanro": {
            ...
            "description_classic": "已上名甘露日，是大吉祥，宜冊立、受灌頂法、造作寺宇及受戒、習學經法、出家修道，一切並吉。（T21 p.398b）",
        ...
        "kongou": {
            ...
            "reading": "こんごうぶび",
            "level": "吉",
            "description": "宿曜經記載的吉日。原典記載「宜作一切降伏法，誦日天子呪及作護摩，並諸猛利等事」（T21 p.398b-c）。適合護摩修法、降伏法、寫經、授戒、面試、考試等需要毅力與持續力的行動。",
            "description_classic": "已上名金剛峯日，宜作一切降伏法，誦日天子呪及作護摩，並諸猛利等事。（T21 p.398b-c）",
            "description_ja": "金剛峯日は吉日なり。原典に「一切の降伏法を作し、日天子呪を誦し、及び護摩を作し、並びに諸の猛利等の事に宜し」とある（T21 p.398b-c）。護摩修法・降伏法・写経・授戒など猛利の行に最適なり。"
        },
        "rasetsu": {
            "name": "羅刹日",
            "reading": "らせつび",
            "level": "凶",
            "description": "宿曜經記載的凶日。原典記載「不宜舉百事，必有殃禍」（T21 p.398c），品五另記「不宜舉動百事，唯射獵及諸損害之事也」。避免一切重要行動，適合靜守、閉關自省、誦經迴向。",
            "description_classic": "已上名羅刹日，不宜舉百事，必有殃禍。（T21 p.398c）右此等七日名為羅刹日，不宜舉動百事，唯射獵及諸損害之事也。（T21 p.392c）",
            "description_ja": "羅刹日は凶日なり。原典に「百事を挙ぐるに宜しからず、必ず殃禍あり」とある（T21 p.398c）。一切の重要なる行事を避け、静守・閑居自省・誦経回向に充てるべし。"
        }
    }
    ...
    SANKI_CYCLE = [
        {"name": "躍動の週", "reading": "やくどうのしゅう", "start_relation": "命",
         ...
         "description_classic": "（編者歸納）一九者，命宿起行之期。原典記載業宿日「所作皆吉祥」（T21 p.391b），栄・安・成・友・親日皆吉。",
    ...
    SANKI_DAY_TYPES = {
        ...
        "day": {
            ...
            5: {"name": "危の日", "reading": "きのひ",
                "description": "原典記載「宜結交、定婚姻，歡宴聚會並吉」，但另記「危壞日，並不宜遠行出、入移徙、買賣、婚姻、裁衣、剃頭、沐浴並凶」（注：婚姻在兩處記載吉凶不同）。社交聚會吉，遠行買賣則宜避開。",
    ...
    # 真言宗修行對照資料（九曜流年法・寺院傳承，非 T21n1299 原典）
    SHINGON_KUYOU_DATA = {
        "羅喉星": {
            "practice_name": "閉關沉潛期",
            "practice_level": "精進",
            "description": (
                "修行者的羅喉星年，是密法精進的絕佳時機。世俗觀點視此年為大凶，但在密教的修行觀中，"
            ...
            "description_classic": "（編者歸納）羅喉者，日月之蝕神也。梵名 Rahu，隱覆光明，百事阻滯。然修行者於此年閉關精進，反能破暗見明，轉障為道。",
            ...
            "core_teaching": "密教即身成佛之教：逆境非阻礙，乃照見自心之明鏡。修行者於暗中精進，正是即身成佛之實踐。",
        ...
        "土曜星": {
            ...
            "description_classic": "（編者歸納）土曜者，鎮星也。梵名 Śani，主穩重遲緩。此年宜固根基，不宜急進。如大地承載萬物，能持能載之時也。",
        ...
        "水曜星": {
            ...
            "description_classic": "（編者歸納）水曜者，辰星也。梵名 Budha，主智慧流通。此年智慧如水潤澤，宜研讀經典、廣學多聞。然水亦有暗流，宜靜心澄慮。",
        ...
        "金曜星": {
            ...
            "description_classic": "（編者歸納）金曜者，太白星也。梵名 Śukra，主收斂純淨。此年宜累積福德、莊嚴身儀。人事有變動，乃提煉善緣之時。",
        ...
        "日曜星": {
            ...
            "description_classic": "（編者歸納）日曜者，太陽也。梵名 Sūrya，主光明盛大。此年萬事亨通，福慧增長。宜積極行事，弘法利生。最上吉年也。",
        ...
        "火曜星": {
            ...
            "description_classic": "（編者歸納）火曜者，熒惑星也。梵名 Maṅgala，主急躁衝動。此年多災厄變動，宜忍辱精進。以慈悲心化瞋恚火，轉煩惱為菩提。",
        ...
        "計都星": {
            ...
            "description_classic": "（編者歸納）計都者，月之降交點也。梵名 Ketu，主停滯隱晦。此年事多遲滯，進退不明。宜潛修蓄力，以待時機。釋迦如來之智慧光明，照破無明。",
        ...
        "月曜星": {
            ...
            "description_classic": "（編者歸納）月曜者，太陰也。梵名 Candra，主柔和慈愛。此年人緣殊勝，感受力增強。宜慈悲行善、護持眾生。大吉之年也。",
        ...
        "木曜星": {
            ...
            "description_classic": "（編者歸納）木曜者，歲星也。梵名 Bṛhaspati，主發展繁榮。此年福德圓滿，百事成就。宜發大願、弘法利生。最上吉年也。",
    ...
    def _analyze_compound_factors(
        ...
        if ryouhan and is_auspicious_relation:
            results.append({
                ...
                "description_classic": "（編者歸納）凌犯中遇吉配，表吉實險。原典：「亦宜修福念善」（T21 p.391b）。"
            })
        ...
        if mansion_relation_type == "ankai" and is_dark_week and sanki_day_type in dark_week_bad_days:
            results.append({
                ...
                "description_classic": "（編者歸納）安壊逢破壊の凶日，凶因重疊。原典壊日：「餘並不堪」（T21 p.397c）。"
            })
    ...
    def _ics_day_tip(level: str | None, personal: dict | None, day: dict) -> str:
        ...
        if is_dark:
            ...
            if day_type == '栄の日':
                return '破壊の週但逢栄日，原典記載諸吉事並大吉。可正常行動'
            if day_type == '安の日':
                return '破壊の週但逢安日，原典記載作壇場並吉。穩定踏實的一天'
            if day_type == '成の日':
                return '破壊の週但逢成日，原典記載修道學問、成就法並吉。適合修行精進'
            if day_type == '壊の日':
            ...
            if day_type == '危の日':
                return '破壊の週危日，原典記載結交、歡宴聚會並吉。社交可行，重大決定宜避開'
