...
class SukuyodoService:
    ...
    SHINGON_KUYOU_DATA = {
        ...
        "土曜星": {
            ...
            "recommended_practices": ["觀音法門", "大悲咒持誦", "經行禪"],
            "mantra": {
                "buddha": "聖觀音",
                "name": "聖觀音真言",
                "text": "オン アロリキャ ソワカ",
            ...
            "category_practice": {
                ...
                "health": "身體是修行的道器，這一年特別需要保養。規律作息、適度運動、清淡飲食。每天散步三十分鐘，邊走邊持誦大悲咒，身心同修。",
            ...
            "monthly_tips": {
                ...
                "6": "夏安居開始：安住當下，不被外境牽著走。每天固定時間持誦大悲咒。",
        ...
        "水曜星": {
            ...
            "recommended_practices": ["彌勒菩薩法", "般若經研讀", "寫經修行"],
            "mantra": {
                "buddha": "彌勒菩薩",
                "name": "彌勒菩薩真言",
                "text": "オン マイタレイヤ ソワカ",
        ...
        "金曜星": {
            ...
            "description": (
                ...
                "把目光放遠到生生世世的修行大業。今年的每一個善行，都在淨土的蓮花池中種下種子。"
            ),
            ...
            "practice_focus": "累積福德資糧、淨化身口意、修淨土法門",
            "recommended_practices": ["阿彌陀如來法", "念佛行", "放生護生"],
            "mantra": {
                "buddha": "阿彌陀如來",
                "name": "阿彌陀如來真言",
            ...
            "category_practice": {
                ...
                "health": "金主肺，注意呼吸系統保養。練習深呼吸配合念佛，每一口呼吸都是與佛相應的機會。秋天特別注意保暖，預防感冒。",
            ...
            "monthly_tips": {
                ...
                "3": "春季彼岸會：以布施迴向功德，願一切眾生同生淨土。",
                "4": "灌佛會（4/8）：佛誕日是大供養的好時機。以清淨心供花供水。",
                "5": "護生月：放生護生，以實際行動累積福德。即使放一隻蟲子出窗外也是善行。",
                "6": "夏安居開始：密集念佛，每日持名號千遍以上。",
        ...
        "日曜星": {
            ...
            "recommended_practices": ["千手觀音法", "大悲懺", "利他行"],
            "mantra": {
                "buddha": "千手觀音",
                "name": "千手觀音真言",
                "text": "オン バザラ タラマ キリク",
        ...
        "計都星": {
            ...
            "recommended_practices": ["釋迦如來法", "梁皇寶懺", "抄經"],
            "mantra": {
                "buddha": "釋迦如來",
                "name": "釋迦如來真言",
